...
namespace vMenuClient
{
    public class PlayerAppearance
    {
        ...
        private void CreateMenu()
        {
            ...
            List<string> walkstyles = new List<string>() { "Нормальная", "Раненый", "Здоровяк", "Женская", "Гангстер", "Шикарная", "Сексуальная", "Бизнес", "Пьяный", "Хипстер" };
            MenuListItem walkingStyle = new MenuListItem("Походка", walkstyles, 0, "Изменить походку.");
            List<string> clothingGlowAnimations = new List<string>() { "Вкл", "Выкл", "Фейд", "Вспышка" };
